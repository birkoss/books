...
urlpatterns = [
    ...
    path('libraries/edit/<str:library_id>/categories/add/', books_views.edit_category, name='library-category/add'),
    ...
    path('libraries/add/', books_views.edit_library, name='library/add'),
